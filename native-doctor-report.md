...
- **Scanner Version**: `v0.7.0`
- **Scan Scope**: 310 relevant files (285 code files, 20 native files)
- **Execution Timing**: file scan 1347ms | static analysis 2604ms | rules run: 16
...
| **Expo Config Plugins** | **15** | Monitored ✓ |
...
---
*Generated by native-doctor v0.7.0 — Developed by Mavrix Technologies*