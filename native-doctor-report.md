...
> **Health Score**: **99/100 [ EXCELLENT ]** | Technical Debt: **LOW**
...
- **Scan Scope**: 310 relevant files (285 code files, 20 native files)
- **Execution Timing**: file scan 1053ms | static analysis 2144ms | rules run: 16
...
| **Warnings** | **1** | Review and fix before release; architecture, performance, or native defect |
...
| :--- | :---: | :--- | :--- |
| **Performance (Render)** | **95/100** | Healthy | UI re-renders, unmemoized array transforms |
...
| **OVERALL MOBILE SCORE** | **99/100** | **EXCELLENT** | Holistic weighted mobile index |
...
| **Native Modules & Bridge** | **46** | Monitored ✓ |
...
- **Confidence**: `HIGH`
- **Location**: `scripts/sync-festival-theme.js:28`
