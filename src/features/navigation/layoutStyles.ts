...
export const styles = StyleSheet.create({
  ...
  iosNativeAccessoryContainer: {
    width: "100%",
    height: 56,
    backgroundColor: "transparent",
    justifyContent: "center",
  },
  iosMiniPlayerAccessoryRoot: {
    width: "100%",
    height: 56,
    overflow: "hidden",
    borderRadius: 16,
  ...
  iosMiniPlayerShellInline: {
    height: 42,
    borderRadius: 12,
  },
  iosMiniPlayerRowInline: {
    height: 42,
    paddingLeft: 4,
    paddingRight: 8,
  },
  iosMiniPlayerArtworkShellInline: {
    width: 36,
    height: "100%",
    alignItems: "center",
    justifyContent: "center",
  },
  iosMiniPlayerCoverInline: {
    width: 32,
    height: 32,
    borderRadius: 6,
  },
  iosMiniPlayerNativeControls: {
    flexDirection: "row",
    alignItems: "center",
    gap: 2,
    marginLeft: 4,
  ...
  iosMiniPlayerNativeControlBtnPressed: {
    opacity: 0.55,
  },
